...
def index():
    ...
    if request.method == 'POST':
        try:
            ...
            logging.info(f'Database connection time: {connection_time:.2f} seconds')
            ...
            insert_statement = """
                INSERT INTO dbo.PLACEMENT (
                    [First_Name], [Last_Name], [Initial], [Register_Number], [College],
                    [Degree], [Your_Department], [Date_Of_birth], [Gender], [10th_Percentage],
                    [10th_Year], [10th_Board], [10th_Board_Others], [10th_School],
                    [10th_Medium], [10th_Medium_Others], [12th_Percentage], [12th_Year],
                    [12th_Board], [12th_Board_Others], [12th_Stream], [12th_Stream_Others],
                    [12th_School], [12th_Medium], [12th_Medium_Others], [Diploma_Percentage],
                    [Diploma_Branch], [Diploma_Year], [Diploma_Class], [Diploma_College],
                    [UG_Semester1], [UG_Semester2], [UG_Semester3], [UG_Semester4],
                    [UG_Semester5], [UG_Semester6], [UG_Semester7], [UG_Semester8],
                    [UG_CGPA], [PG_Semester1], [PG_Semester2], [PG_Semester3],
                    [PG_Semester4], [PG_CGPA], [Arrear_Status], [Number_Of_Attempts],
                    [Number_Of_Standing], [Arrear_Details], [Skill_Set],
                    [Value_Added_Certificate_Course], [Gate_Tancet_Score], [GRE_TOFEL],
                    [Paper_Presentation], [Language_Known], [Language_Known_others],
                    [Mobile_Number], [E_Mail], [Permanent_Address], [Permanent_City],
                    [Permanent_Pincode], [Present_Address], [Present_City],
                    [Present_Pincode], [Father's_Name], [Father's_Initial],
                    [Mother's_Name], [Mother's_Initial], [Father's_Occupation],
                    [Mother's_Occupation], [Fathert's_Mobile], [Mother's_Mobile],
                    [Community], [Hosteller_Dayscholar], [Cutoff_Mark],
                    [Mode_Of_Admission], [First_Graduate], [Blood_Group],
                    [Register_For_Placement], [Passport_Details], [Aadhaar_Details],
                    [Pan_Card], [Ration_Card], [Annual_Income], [sibling]
                ) VALUES (
                    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
                    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
                    ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
            ...
            logging.info(f'Database execution time: {execution_time:.2f} seconds')
            ...
            if cursor:
                cursor.rollback()  # Rollback the transaction in case of an error
